# Tutorium Grundlagen Datenbanken WS1718
...
Eine Installationsanleitung für git ist in diesem repository [hinterlegt](./git_installation/README.md). Eine Installationsanleitung für sqlplus ist auch [verfügbar](./sqlplus_installation/README.md).
